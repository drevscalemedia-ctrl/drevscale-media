      ...
      <main>
        ...
        <section className="relative bg-[#111318] text-white overflow-hidden py-28">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -bottom-20 left-0 w-[500px] h-[400px] rounded-full bg-[#1D9BF0]/8 blur-[100px]" />
          </div>
          <div className="relative max-w-5xl mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              <p className="text-[#7DD3FC] font-semibold text-sm uppercase tracking-widest mb-4">About</p>
              <h1 className="font-display text-6xl md:text-7xl font-black leading-none mb-6">
                Local guy.<br />
                <em className="not-italic text-[#1D9BF0]">Real results.</em>
              </h1>
        ...
        <section className="py-24 bg-[#111318]">
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              <p className="text-[#7DD3FC] font-semibold text-sm uppercase tracking-widest mb-3">How I Work</p>
        ...
        <section className="py-24 bg-[#FFFFFF]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              <p className="text-[#1D9BF0] font-semibold text-sm uppercase tracking-widest mb-3">The Honest Comparison</p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 rounded-3xl border-2 border-[#1D9BF0] bg-white"
              >
                ...
                <div className="space-y-3">
                  {drevscalePros.map((item) => (
                    <div key={item} className="flex items-start gap-3 text-sm text-[#1C1F2E]">
                      <CheckCircle2 size={16} className="text-[#1D9BF0] flex-shrink-0 mt-0.5" />
                      {item}
                    </div>
                  ))}
                </div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="p-8 rounded-3xl border border-[#CBD5E1] bg-[#FFFFFF]"
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#CBD5E1] flex items-center justify-center">
                    <XCircle size={20} className="text-[#64748B]" />
                  </div>
                  <h3 className="font-display text-xl font-black text-[#64748B]">Big Agencies</h3>
                </div>
                <div className="space-y-3">
                  {agencyCons.map((item) => (
                    <div key={item} className="flex items-start gap-3 text-sm text-[#64748B]">
                      <XCircle size={16} className="text-[#CBD5E1] flex-shrink-0 mt-0.5" />
                      {item}
                    </div>
                  ))}
                </div>
        ...
        <section className="py-24 bg-[#F1F5F9] text-center">
          <div className="max-w-2xl mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-[#64748B] text-lg mb-10">Book a free 20-minute strategy call. No pitch — just a real conversation about what's possible.</p>
              <Link
                href="/contact"
