      ...
      <main>
        ...
        <section className="relative bg-[#111318] text-white overflow-hidden py-28">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -bottom-20 left-0 w-[500px] h-[400px] rounded-full bg-[#4A90D9]/8 blur-[100px]" />
          </div>
        ...
        <section className="py-24 bg-[#FFFFFF]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              <p className="text-[#4A90D9] font-semibold text-sm uppercase tracking-widest mb-3">The Honest Comparison</p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 rounded-3xl border-2 border-[#4A90D9] bg-white"
              >
                ...
                <div className="space-y-3">
                  {drevscalePros.map((item) => (
                    <div key={item} className="flex items-start gap-3 text-sm text-[#1C1F2E]">
                      <CheckCircle2 size={16} className="text-[#4A90D9] flex-shrink-0 mt-0.5" />
                      {item}
                    </div>
                  ))}
                </div>
        ...
        <section className="py-24 bg-[#F1F5F9] text-center">
          <div className="max-w-2xl mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <p className="text-[#4A90D9] font-semibold text-sm uppercase tracking-widest mb-4">Work With Me</p>
