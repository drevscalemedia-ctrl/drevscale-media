      ...
      <main>
        ...
        <section className="relative bg-[#111318] text-white overflow-hidden py-28">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -bottom-20 left-1/3 w-[500px] h-[400px] rounded-full bg-[#1D9BF0]/10 blur-[100px]" />
          </div>
          <div className="relative max-w-5xl mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              <p className="text-[#7DD3FC] font-semibold text-sm uppercase tracking-widest mb-4">Contact</p>
              <h1 className="font-display text-6xl md:text-7xl font-black leading-none mb-6">
                Let's<br />
                <em className="not-italic text-[#1D9BF0]">talk.</em>
              </h1>
              ...
              >
                ...
                <div className="space-y-5 mb-10">
                  <a
                    ...
                    className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-[#CBD5E1] hover:border-[#1D9BF0]/50 transition-colors group"
                  >
                    <div className="w-12 h-12 rounded-xl bg-[#1D9BF0]/10 flex items-center justify-center flex-shrink-0">
                      <Phone size={20} className="text-[#1D9BF0]" />
                    </div>
                    <div>
                      <p className="text-[#64748B] text-xs uppercase tracking-wider font-semibold mb-0.5">Phone</p>
                      <p className="font-semibold text-[#1C1F2E] group-hover:text-[#1D9BF0] transition-colors">{BRAND.phone}</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-[#1C1F2E] group-hover:text-[#1D9BF0] transition-colors">{BRAND.email}</p>
                    </div>
                  </a>

                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-[#CBD5E1]">
                    <div className="w-12 h-12 rounded-xl bg-[#1D9BF0]/10 flex items-center justify-center flex-shrink-0">
                      <MapPin size={20} className="text-[#1D9BF0]" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-[#CBD5E1]">
                    <div className="w-12 h-12 rounded-xl bg-[#1D9BF0]/10 flex items-center justify-center flex-shrink-0">
                      <Clock size={20} className="text-[#1D9BF0]" />
                    </div>
                    <div>
