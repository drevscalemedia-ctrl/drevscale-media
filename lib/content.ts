...
export const TESTIMONIALS = [
  {
    ...
    name: "Dave Moretti",
    business: "Moretti Cooling & Heating, Phoenix AZ",
  ...
  },
  {
    ...
    name: "Ashley Thorne",
    business: "Azure Aesthetics Med Spa, Scottsdale AZ",
  ...
  },
  {
    ...
    name: "Dr. Kevin Walsh",
    business: "Walsh Family Dental, Phoenix AZ",
...
export const CASE_STUDIES = [
  ...
  },
  {
    ...
    clientName: "J. Harrington",
    location: "Phoenix, AZ",
    before: { leads: 5, cpl: 95, roas: 1.2 },
    after: { leads: 22, cpl: 14.5, roas: 3.8 },
    adSpend: 320,
    timeframe: "30 days",
    summary: "Retargeting campaign combined with interest-based targeting for women 28–55 in north Phoenix. Promo offer drove direct booking page visits.",
    quote: "The quality of leads was just as impressive as the volume.",
  },
  {
    industry: "Local Restaurant",
    clientName: "M. Castillo",
    location: "Phoenix, AZ",
